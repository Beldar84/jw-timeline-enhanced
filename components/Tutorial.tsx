...
const Tutorial: React.FC<TutorialProps> = ({ onComplete, onSkip }) => {
  ...
  const steps: TutorialStep[] = [
    ...
    { title: 'Mazos temáticos', description: 'Puedes elegir entre diferentes mazos: Biblia Completa, Antiguo Testamento, Nuevo Testamento, y mazos especializados como Reyes, Patriarcas o Vida de Jesús.', icon: I.books, tip: 'Cada mazo tiene diferente dificultad. ¡Empieza con uno fácil!' },
